		...
		do {
			...
			case 1:
				...
				while (true) {
					...
					log.info("*Please Specify it in Alphabets*");
				...
				while (true) {
					...
					log.info("Minimum 8 characters" + "Atleast 1 Capital Letter,1 Special Character");
				...
				while (true) {
					...
					log.info("*Please Specify Dealer/Manufacturer:*");
